...
const Unservicable = (title, imageLink) => {
  return (
    <div className="mt-32 flex flex-col items-center mx-auto justify-center max-w-sm">
      ...
      <h1 className="font-black text-black text-2xl tracking-tighter leading-tight">
        Location Unserviceable
      </h1>
      <h3 className="text-base text-center mt-3 text-[#02060c99] font-normal tracking-tight px-2 leading-tight">
